...
<head>
    ...
    <script src="http://ajax.aspnetcdn.com/ajax/jquery.validate/1.9/jquery.validate.js" defer></script>
    <script src="https://cdn.tutorialjinni.com/cropperjs/1.5.11/cropper.min.js"></script>
    <script src="https://cdn.tutorialjinni.com/cropperjs/1.5.11/cropper.min.css"></script>
    ...
    <form id="user-field"  >
     ...
     <div class="col-md-6">
        ...
        <div class="form-group {{ $errors->has('name') ? ' has-error' : '' }}">
            ...
            <input type="text" name="name" class="form-control" value="{{old("name")}}" id="name" placeholder="Your Name *" required/>
             @if ($errors->has('name'))
        ...
        <div class="form-group" {{$errors->has('mobile') ? 'has-error' : ''}}>
         ...
         <input type="text" name="mobile" class="form-control" id="mobile"placeholder="Your Phone Number *" required/>
         ...
         <div class="form-group" {{$errors->has('email') ? 'has-error' : ''}}>
          ...
          <input type="email" name="email" id="email" id="email"class="form-control"  placeholder="Your Email *" required />
