...
<body>
   <div class="container contact-form col-lg-6 col-md-offset-4" style="margin-top:100px;">
    ...
    <form id="user-field" method="POST" action ="{{ route('users.store')}} " >
     {{-- {{ csrf_field()}} --}}
     @csrf
     <div class="col-md-6">
        ...
        <div class="form-group" {{$errors->has('mobile') ? 'has-error' : ''}}>
         ...
         <input type="text" name="mobile" class="form-control" placeholder="Your Phone Number *"maxlength="10" required />
        ...
        <div class="form-group">
            ...
            <button type="button" name="btnSubmit" class="btn btn-primary btn-square btn-sm col-lg-8 col-md-offset-2" > Submit </button>
            {{-- name="btnSubmit" / this is after the class ==> data-toggle="modal" data-target="#exampleModal" data-whatever="@getbootstrap"   this is inside the button if i want to added it --}}
        </div>
     </div>
    ...
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-footer">
            <button id="send_form" type="submit" type="button" class="btn btn-secondary" data-dismiss="modal">إغلاق</button>
