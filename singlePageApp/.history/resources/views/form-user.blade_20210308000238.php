    ...
    <form id="user-field"  >
     ...
     <div class="col-md-6">
        ...
        <div class="form-group">
            ...
            <button id="click"  type="submit" class="btn btn-primary btn-square btn-sm col-lg-8 col-md-offset-2 submit" data-toggle="modal" data-target="#exampleModal" data-whatever="@getbootstrap" > Submit </button>
