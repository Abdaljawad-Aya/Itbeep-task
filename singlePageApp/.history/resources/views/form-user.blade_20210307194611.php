    ...
    <form method="POST" action ="{{ route('users.store')}}" >
     ...
     <div class="col-md-6">
        ...
        <div class="form-group">
            ...
            <button type="button" name="btnSubmit" class="btn btn-primary btn-square btn-sm col-lg-8 col-md-offset-2" value="إرسال" data-toggle="modal" data-target="#exampleModal" data-whatever="@getbootstrap"> </button>
        </div>
     </div>
