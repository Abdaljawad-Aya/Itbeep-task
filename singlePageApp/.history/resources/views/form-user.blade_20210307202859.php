    ...
    <form id="user-field" method="POST" action ="{{ route('users.store')}} javascript:void(0)" >
     ...
     <div class="col-md-6">
        ...
        <div class="form-group">
            ...
            <button type="button" name="btnSubmit" class="btn btn-primary btn-square btn-sm col-lg-8 col-md-offset-2" value="إرسال" data-toggle="modal" data-target="#exampleModal" data-whatever="@getbootstrap"> إرسال </button>
        </div>
     </div>
      ...
      $("#user-field").validate({
          ...
          messages: {
              name: {
                  ...
                  maxlength: "Your last nam maxlength should be 50 characters long."
              }
          }
      })
  }
