    ...
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-body">
            ...
            <div class="form-group center">
                <button type="button" class="btn btn-primary btn-square btn-sm col-lg-8 col-md-offset-2"> عرض3</button>
                <button type="button" class="btn btn-primary dark"> عرض2</button>
                <button type="button" class="btn btn-primary dark"> عرض1</button>
