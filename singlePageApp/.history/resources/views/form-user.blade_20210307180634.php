    ...
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-body">
            ...
            <div class="form-group center">
                ...
                <button type="button" class="btn btn-primary btn-square btn-sm col-lg-2 col-md-offset-2"> عرض2</button>
                <button type="button" class="btn btn-primary btn-square btn-sm col-lg-2 col-md-offset-2"> عرض1</button>
