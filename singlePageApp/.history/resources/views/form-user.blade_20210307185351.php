    ...
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-body">
            ...
            <div class="form-group ">
                ...
                <button type="button" style=" background-color:rgb(95, 51, 95); color:#FFF;" class=" btn-square btn-sm col-lg-3 col-md-offset-2"> عرض3</button>
                <button type="button" style=" background-color:rgb(95, 51, 95); color:#FFF;"class="btn-square btn-sm col-lg-3 col-md-offset-1"> عرض2</button>
                <button type="button" style=" background-color:rgb(95, 51, 95); color:#FFF;"class="btn-square btn-sm col-lg-3 col-md-offset-1"> عرض1</button>
                 <br> <br>
