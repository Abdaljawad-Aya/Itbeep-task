    ...
    <form id="user-field" method="POST" action ="{{ route('users.store')}} " >
     ...
     <div class="col-md-6">
        ...
        <div class="form-group" {{$errors->has('mobile') ? 'has-error' : ''}}>
         ...
         <input type="text" name="mobile" class="form-control" placeholder="Your Phone Number *" required maxlength="10"/>
        ...
        <div class="form-group">
            ...
            <button id="send_form" type="submit" class="btn btn-primary btn-square btn-sm col-lg-8 col-md-offset-2" > Submit </button>
