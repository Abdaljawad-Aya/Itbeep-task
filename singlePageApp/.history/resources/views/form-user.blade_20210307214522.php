    ...
    <form id="user-field" method="post" action ="{{ route('users.store')}} " >
     ...
     <div class="col-md-6">
        ...
        <div class="form-group">
            ...
            <button id="send_form" type="submit" class="btn btn-primary btn-square btn-sm col-lg-8 col-md-offset-2" data-toggle="modal" data-target="#exampleModal" data-whatever="@getbootstrap" > Submit </button>
