        ...
        <div class="modal-body">
            ...
            <div class="form-group ">
                ...
                <button type="button" style=" background-color:rgb(95, 51, 95); color:#FFF;"class="btn-square btn-sm col-lg-2 col-md-offset-1"> عرض1</button>
                 <br> <br>
                <button type="button"style=" background-color:rgb(95, 51, 95); color:#FFF;" class=" btn-square btn-sm col-lg-4 col-md-offset-4">التالي</button>
